...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="data_user_course.php">Data Courses User</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-4">
        ...
        <p>Data Course User :</p>
        <button class="btn btn-primary mb-3" id="addUserBtn">Tambah Course User</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addUserBtn').click(function() {
                window.location.href = 'edit_course_user.php';
            });
        ...
        function fetchUsers() {
            $.ajax({
                url: 'http://localhost/diskominfo/api/api.php/data_course_user',
                method: 'GET',
                success: function(data) {
                    ...
                    data.forEach(function(item) {
                        ...
                        // html += '<td>';
                        // html += '<a href="edit_course_user.php?id=' + item.id + '" class="btn btn-sm btn-warning">Edit</a> ';
