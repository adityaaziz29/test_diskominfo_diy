...
<body>
    ...
    <div class="container mt-4">
        ...
        <p>Data Course :</p>
        <button class="btn btn-primary mb-3" id="addUserBtn">Tambah Course</button>
    ...
    <script>
        ...
        function fetchUsers() {
            $.ajax({
                url: 'http://localhost/diskominfo/api/api.php/data_course',
                method: 'GET',
                success: function(data) {
                    ...
                    data.forEach(function(item) {
                        ...
                        html += '<td>';
                        html += '<a href="edit_course.php?id=' + item.id + '" class="btn btn-sm btn-warning">Edit</a> ';
